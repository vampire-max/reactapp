      ...
      <div className="form-wrapper">
              ...
              <div className="px-40">
                ...
                <div className="margin-40 border">
                  <form className="form" noValidate autoComplete="off">
                    <Input label={"Email or phone"} required />
        ...
        <footer className="footer">
          ...
          <ul className="margin-0">
            <li>
              <a
                href="https://support.google.com/accounts?hl=id"
                target="_blank"
              >
                Help
              </a>
            ...
            <li>
              <a
                href="https://accounts.google.com/TOS?loc=CN&amp;hl=id&amp;privacy=true"
                target="_blank"
              >
                Privacy
              </a>
            ...
            <li>
              <a
                href="https://accounts.google.com/TOS?loc=CN&amp;hl=id"
                target="_blank"
              >
                Terms
              </a>
